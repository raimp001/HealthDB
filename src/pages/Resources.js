  ...
  const whitepapers = [
    ...
    },
    {
      ...
      sections: [
        ...
        { title: '2. Data Architecture', content: 'Target state: PHI encrypted at rest with keys in a managed KMS backed by hardware security modules. Today HealthDB relies on the hosting provider default encryption and has no KMS integration, so key management is not something it controls or can evidence.' },
